...
const MemoryChunkSchema = new mongoose_1.Schema({
    userId: {
...
const MemoryChunk = mongoose_1.default.model("MemoryChunk", MemoryChunkSchema);
exports.default = MemoryChunk;
//# sourceMappingURL=MemoryChunk.js.map